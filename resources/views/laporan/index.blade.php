@extends('layouts.app')
@section('title', 'Laporan — SIM UKM Jurnalistik')
        ...
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body text-center py-4">
                ...
                <div class="d-flex gap-2 justify-content-center">
                    <a href="{{ route('laporan.anggota') }}" class="btn btn-outline-primary btn-sm"><i class="bi bi-eye me-1"></i>Preview</a>
                    <a href="{{ route('laporan.anggota.pdf') }}" class="btn btn-danger btn-sm"><i class="bi bi-filetype-pdf me-1"></i>PDF</a>
                    <a href="{{ route('laporan.anggota.excel') }}" class="btn btn-success btn-sm"><i class="bi bi-filetype-xlsx me-1"></i>Excel</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body text-center py-4">
                ...
                <div class="d-flex gap-2 justify-content-center">
                    <a href="{{ route('laporan.event') }}" class="btn btn-outline-info btn-sm"><i class="bi bi-eye me-1"></i>Preview</a>
                    <a href="{{ route('laporan.event.pdf') }}" class="btn btn-danger btn-sm"><i class="bi bi-filetype-pdf me-1"></i>PDF</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body text-center py-4">
                ...
                <div class="d-flex gap-2 justify-content-center">
                    <a href="{{ route('laporan.keuangan') }}" class="btn btn-outline-warning btn-sm"><i class="bi bi-eye me-1"></i>Preview</a>
                    <a href="{{ route('laporan.keuangan.pdf') }}" class="btn btn-danger btn-sm"><i class="bi bi-filetype-pdf me-1"></i>PDF</a>
                </div>
            </div>
        </div>
    </div>
