<?php $__env->startSection('title', 'Dashboard — SIM UKM Jurnalistik'); ?>
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-lg me-3 bg-white bg-opacity-25">
                            <?php echo e(strtoupper(substr($user->nama_lengkap, 0, 2))); ?>

                        </div>
                        <div>
                            <h5 class="mb-1">Selamat Datang, <?php echo e($user->nama_lengkap); ?>!</h5>
                            <p class="mb-0 opacity-75"><?php echo e($user->jabatan_lengkap); ?> — Divisi <?php echo e(ucfirst(str_replace('_', ' & ', $user->divisi ?? '-'))); ?></p>
                        </div>
                    </div>
...
<div class="row g-4">
    <div class="col-lg-6">
        <div class="card h-100">
            ...
            <div class="card-body">
                <?php $__empty_1 = true; $__currentLoopData = $eventMendatang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                        <div class="bg-primary bg-opacity-10 rounded-3 p-2 me-3 text-center" style="min-width: 50px;">
                            <div class="fw-bold text-primary"><?php echo e($event->tanggal_mulai->format('d')); ?></div>
                            <div class="small text-muted"><?php echo e($event->tanggal_mulai->format('M')); ?></div>
                        </div>
                        <div>
                            <div class="fw-semibold"><?php echo e($event->nama_event); ?></div>
                            <div class="small text-muted"><?php echo e($event->lokasi ?? '-'); ?></div>
                        </div>
                    </div>
            ...
            <div class="card-body">
                <table class="table table-borderless mb-0">
                    <tr>
                        ...
                        <td class="fw-semibold"><?php echo e($user->nim); ?></td>
                    </tr>
                    <tr>
                        <td class="text-muted">Divisi</td>
                        <td class="fw-semibold"><?php echo e(ucfirst(str_replace('_', ' & ', $user->divisi ?? '-'))); ?></td>
                    </tr>
                    <tr>
                        <td class="text-muted">Status</td>
                        <td><span class="badge bg-success"><?php echo e(ucfirst($user->status_keanggotaan)); ?></span></td>
                    </tr>
                    <tr>
                        <td class="text-muted">Bergabung</td>
                        <td class="fw-semibold"><?php echo e($user->tanggal_bergabung?->format('d M Y') ?? '-'); ?></td>
                    </tr>
                </table>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paulina\UKM Jurnalistik\resources\views/dashboard/anggota-aktif.blade.php ENDPATH**/ ?>