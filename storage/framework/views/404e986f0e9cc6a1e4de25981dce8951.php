...
<body>
    <div class="header">
        ...
        <p>Dicetak: <?php echo e(now()->translatedFormat('d F Y, H:i')); ?> WITA</p>
    </div>

    <div class="summary">
        <div class="summary-item">
            <div class="value">Rp <?php echo e(number_format($totalDivisiAnggaran, 0, ',', '.')); ?></div>
            <div class="label">Divisi — Anggaran</div>
        </div>
        <div class="summary-item">
            <div class="value">Rp <?php echo e(number_format($totalDivisiTerpakai, 0, ',', '.')); ?></div>
            <div class="label">Divisi — Terpakai</div>
        </div>
        <div class="summary-item">
            <div class="value">Rp <?php echo e(number_format($totalEventAnggaran, 0, ',', '.')); ?></div>
            <div class="label">Event — Dianggarkan</div>
        </div>
        <div class="summary-item">
            <div class="value">Rp <?php echo e(number_format($totalEventRealisasi, 0, ',', '.')); ?></div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-end">Rp <?php echo e(number_format($ad->jumlah_anggaran - $ad->jumlah_terpakai, 0, ',', '.')); ?></td>
            </tr>
    ...
    <div class="footer">
        SIM UKM Jurnalistik — Politeknik Negeri Samarinda © <?php echo e(date('Y')); ?>

    </div>
</body>
</html>
<?php /**PATH C:\Users\Paulina\UKM Jurnalistik\resources\views/pdf/laporan-keuangan.blade.php ENDPATH**/ ?>