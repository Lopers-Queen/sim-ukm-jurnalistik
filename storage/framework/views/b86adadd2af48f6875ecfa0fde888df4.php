...
unset($__errorArgs, $__bag); ?>" id="judul" name="judul"
               value="<?php echo e(old('judul', $isEdit ? $naskah->judul : '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="kategori" name="kategori"
               value="<?php echo e(old('kategori', $isEdit ? $naskah->kategori : '')); ?>" placeholder="Contoh: Berita, Opini">
...
unset($__errorArgs, $__bag); ?>" id="konten" name="konten" rows="12" required><?php echo e(old('konten', $isEdit ? $naskah->konten : '')); ?></textarea>
...
<?php /**PATH C:\Users\Paulina\UKM Jurnalistik\resources\views/naskah/_form.blade.php ENDPATH**/ ?>