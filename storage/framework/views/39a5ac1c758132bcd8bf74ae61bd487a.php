        ...
        <div class="card shadow-sm border-0 login-card">
            <div class="card-body p-4">
                ...
                <div class="text-center mb-4">
                    <img src="<?php echo e(asset('assets/logo.png')); ?>" alt="Logo UKM Jurnalistik" class="mb-3" style="width: 80px; height: 80px; object-fit: contain;">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="nim" name="nim"
                                   value="<?php echo e(old('nim')); ?>" required autofocus
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="<?php echo e(route('password.request')); ?>" class="small text-decoration-none">Lupa password?</a>
                    </div>
...
<?php /**PATH C:\Users\Paulina\UKM Jurnalistik\resources\views/auth/login.blade.php ENDPATH**/ ?>