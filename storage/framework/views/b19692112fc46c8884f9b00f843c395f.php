...
<body>
    ...
    <div class="summary">
        <div class="summary-item">
            <div class="value"><?php echo e($events->count()); ?></div>
            <div class="label">Total Event</div>
        </div>
        <div class="summary-item">
            <div class="value">Rp <?php echo e(number_format($totalAnggaran, 0, ',', '.')); ?></div>
            <div class="label">Total Anggaran</div>
        </div>
        <div class="summary-item">
            <div class="value">Rp <?php echo e(number_format($totalRealisasi, 0, ',', '.')); ?></div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><strong><?php echo e($event->nama_event); ?></strong></td>
                <td><?php echo e($event->tanggal_mulai->format('d/m/Y')); ?></td>
...
<?php /**PATH C:\Users\Paulina\UKM Jurnalistik\resources\views/pdf/laporan-event.blade.php ENDPATH**/ ?>